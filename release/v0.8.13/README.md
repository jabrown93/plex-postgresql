...
[📥 Download v0.8.13](https://github.com/cgnl/plex-postgresql/releases/tag/v0.8.13) (macOS ARM64, 100KB)
...
**Latest Release:** [v0.8.13](https://github.com/cgnl/plex-postgresql/releases/tag/v0.8.13) - Fixes std::bad_cast in TV shows endpoint

```bash
# Download and extract
curl -L https://github.com/cgnl/plex-postgresql/releases/download/v0.8.13/plex-postgresql-v0.8.13-macos-arm64.tar.gz -o plex-pg.tar.gz
...
### ✅ FIXED in v0.8.13: TV Shows HTTP 500 Error

**Status:** Fixed in v0.8.13  
...
**Action:** Update to v0.8.13 or later
...
- **BIGINT** → INT8 (64-bit) - ✅ Fixed in v0.8.13
